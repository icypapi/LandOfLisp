...
public class UnboundedMagicMap extends AbstractMap {

    public UnboundedMagicMap(int width, int height, int startEnergy, int moveEnergy, int plantEnergy, double jungleRatio, int startAnimalsNumber) {
